...
export default function Login() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const response = await login(email.toString().trim(), password.toString().trim());
            ...
            <div className="max-w-md w-full">
                ...
                <div className="bg-gray-900 bg-opacity-50 backdrop-blur-sm rounded-2xl border border-gray-800 p-8 shadow-2xl">
                    <div className="text-center mb-8">
                        <h1 className="text-2xl font-bold text-white mb-6">Login to Riverflow</h1>
                ...
                <div className="text-center mt-6">
                    <p className="text-gray-400 text-sm">
                        ...
                        <Link href="/register" className="text-cyan-400 hover:text-cyan-300 transition-colors duration-200 font-medium focus:outline-none focus:underline">
                            Register today
                        </Link>
                    </p>
                </div>
